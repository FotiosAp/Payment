...
const Home = ({ sections, payments, totalExpected, totalCollected, totalRemaining, totalExpenses, extraIncome, onAddPlayer, onDeletePlayer, currentMonthId, setCurrentMonthId, currentYear, setCurrentYear }) => {
    ...
    return (
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px', fontFamily: '"Segoe UI", sans-serif' }}>
            ...
            */}
            ...
            <h2 className="section-h2">Διαχείριση Τμημάτων</h2>
